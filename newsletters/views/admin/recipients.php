		...
		<tbody>
			...
			<tr>
				...
				<?foreach($groups as $group):?>
					<a href="/admin/newsletters/groups/index/<?=$group->group_id?>"><strong><?=htmlentities($group->group_name)?></strong></a><?=$delimiter?>
				<?endforeach?>
				</td>
				<td>
					<a class="button" href="/admin/newsletters/recipients/edit/<?=$recipient->id?>">Edit</a>
				</td>
			</tr>
			<?endforeach?>
		</tbody>

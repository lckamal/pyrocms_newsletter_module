<div id="sortable">
    ...
    <div class="one_half" id="newsletters">
        ...
        <section class="item">
            <div class="content">
                <ul class="list-links">
                    <li><a href="/admin/newsletters/mails/create">Add Newsletter</a></li>
                    <li><a href="/admin/newsletters/mails">Drafts (<?=$this->newsletters->count('draft')?>)</a></li>
                    <li><a href="/admin/newsletters/mails/index/sent">Sent (<?=$this->newsletters->count('sent')?>)</a></li>
                    <li><a href="/admin/newsletters/mails/index/trash">Trash (<?=$this->newsletters->count('trash')?>)</a></li>
                </ul>
            </div>
        </section>
    </div>
    ...
    <div class="one_half" id="recipients">
     ...
     <div class="one_half box" id="groups">
        <section class="draggable title">
            <h4>Groups</h4>
            <a class="tooltip-s toggle" title="Toggle this element"></a>
        </section>
        <section class="item">
            <div class="content">
                <ul class="list-links">
                    <li><a href="/admin/newsletters/groups/create">Add a Group</a></li>
